...
// MikirBot legacy compatibility: the old kiu/@z4phdev fork used custom
// message IDs. Keep both V1 and V2 generators on the old prefix because
// Baileys RC routes most outbound sends through generateMessageIDV2().
export const generateMessageID = () => 'MikirBot-' + randomBytes(6).toString('hex').toUpperCase();
export const generateMessageIDV2 = (_userId) => generateMessageID();
